...
const ROUTES = new Map([
  ...
  [
    ...
    {
      id: "datacube.getarticlesummary",
      method: "POST",
      public: false,
      kind: "wechat",
      contentKind: "json",
      upstreamPath: "/datacube/getarticlesummary",
      maxBody: "json",
      idempotency: "forbidden",
    },
  ],
  [
    ...
    {
      id: "datacube.getarticletotal",
      method: "POST",
      public: false,
      kind: "wechat",
      contentKind: "json",
      upstreamPath: "/datacube/getarticletotal",
      maxBody: "json",
      idempotency: "forbidden",
    },
  ],
  [
    ...
    {
      id: "datacube.getarticleread",
      method: "POST",
      public: false,
      kind: "wechat",
      contentKind: "json",
      upstreamPath: "/datacube/getarticleread",
      maxBody: "json",
      idempotency: "forbidden",
    },
  ],
  [
    ...
    {
      id: "datacube.getarticleshare",
      method: "POST",
      public: false,
      kind: "wechat",
      contentKind: "json",
      upstreamPath: "/datacube/getarticleshare",
      maxBody: "json",
      idempotency: "forbidden",
    },
  ],
  [
    ...
    {
      id: "datacube.getarticletotaldetail",
      method: "POST",
      public: false,
      kind: "wechat",
      contentKind: "json",
      upstreamPath: "/datacube/getarticletotaldetail",
      maxBody: "json",
      idempotency: "forbidden",
    },
  ],
  [
    ...
    {
      id: "datacube.getbizsummary",
      method: "POST",
      public: false,
      kind: "wechat",
      contentKind: "json",
      upstreamPath: "/datacube/getbizsummary",
      maxBody: "json",
      idempotency: "forbidden",
    },
  ],
